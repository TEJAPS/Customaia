                ...
                <div class="row">
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
						...
						<form action=sample.php method=post   enctype=multipart/form-data>
                            <img src="images/<?php echo $row["image_of_pro"];?>" width=50 height=50 alt="" />
                            <div class="caption">
							
                                <h3><a href="#"><input type=text name=pname id=pname value=<?php echo $row['pname'];?> style="display:none"><?php echo $row['pname'];?></a></h3>
                                <p>Price : <strong><input type=text name=price id=price value=<?php echo $row['price'];?> style="display:none"><?php echo $row['price'];?></strong>  </p>
                                <p><a href="#"><input type=text name=size id=size value=<?php echo $row['size'];?> style="display:none"><?php echo $row['size'];?></a></p>
                                <p><input type=text name=color id=color value=<?php echo $row['color'];?> style="display:none" ><?php echo $row['color'];?></p>
								<p><input type=text name=seller_name id=seller_name value=<?php echo $row['seller_name'];?> style="display:none"><?php echo $row['seller_name'];?></p>
